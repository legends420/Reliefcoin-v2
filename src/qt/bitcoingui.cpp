                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Reliefcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Reliefcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Reliefcoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Reliefcoin help message to get a list with possible Cryptonodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Reliefcoin client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Reliefcoin"); // default title
