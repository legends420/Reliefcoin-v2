...
#   c) node1 mines 32 blocks, so now node 0 has 500000CNMC, node 1 has 4250CNMC, node2 has none.
#   d) node0 sends 601 CNMC to node2, in two transactions (301 CNMC, then 300 CNMC).
