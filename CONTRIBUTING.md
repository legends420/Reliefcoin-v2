Contributing to Cryptonodes Core
==================================

The Cryptonodes Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cryptonodes Core project, and is not to be
confused with overall Cryptonodes Network Protocol consensus changes.

Whether a pull request is merged into Cryptonodes Core rests with the project merge
...
Patches that change Cryptonodes consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cryptonodes consensus, it must have been
...
The project leader is the release manager for each Cryptonodes Core release.
